...
**Archived 2026-09-25** (roadmap WS-F task 6): read-only. For browser realtime use [OpenVibe.Events](https://github.com/OpenVibers/OpenVibe.Events) `GET /realtime/stream` (SSE, authorised topics, cursor resume) through `openvibe-sdk/realtime`.  
